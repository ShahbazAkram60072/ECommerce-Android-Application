...
public class HomeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public void getAllData() {
        DatabaseReference dff = FirebaseDatabase.getInstance().getReference().child("Users").child(auth.getCurrentUser().getUid());
...
//                startActivity(new Intent(getApplicationContext(), CartActivity.class));
            ...
            if (user == null) {
                ...
                startActivity(new Intent(getApplicationContext(), com.shahbaz.rentadressapplicationsemesterproject.UserOrderActivity.class));
            }
            ...
            if (user == null) {
                ...
                startActivity(new Intent(getApplicationContext(), com.shahbaz.rentadressapplicationsemesterproject.ForgetPassActivity.class));
            }
