...
import com.shahbaz.rentadressapplicationsemesterproject.ViewHolder.FavoriteItemAdapter;
...
public class FavoriteItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        df= FirebaseDatabase.getInstance().getReference().child("favorite_List").child("User View").child(user.getUid()).child("Products");
