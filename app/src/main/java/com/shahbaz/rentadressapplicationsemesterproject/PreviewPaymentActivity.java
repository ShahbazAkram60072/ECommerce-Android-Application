...
public class PreviewPaymentActivity extends AppCompatActivity {
    ...
    private String nameS,phoneS,productsNameS,productCodeS,addressS,cityS,diliveryS,pickUpS,amountS;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pickUpS=getIntent().getExtras().get("pickUpDate").toString();
        ...
        pickUp=findViewById(R.id.txt6pickUp);
...
//    }
    ...
    public void confirmorder()
    {
       ...
       // amount=Integer.toString(amount);
        ...
        orderMap.put("pickUpDate",pickUp.getText().toString());
        ...
        orderRef.updateChildren(orderMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                if (task.isSuccessful())
                {
                    ...
                    Intent i=new Intent(getApplicationContext(), com.shahbaz.rentadressapplicationsemesterproject.HomeActivity.class);
