...
public class BridalWearActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bridal_wear);
        setTitle("Bridal Wear");
        auth=FirebaseAuth.getInstance();
        post();

        df = FirebaseDatabase.getInstance().getReference().child("Products");

        rv=findViewById(R.id.rv_BridalWear);
