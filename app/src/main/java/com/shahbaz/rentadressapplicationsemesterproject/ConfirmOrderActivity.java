...
import com.shahbaz.rentadressapplicationsemesterproject.JavaClass.CartProduct;
import com.shahbaz.rentadressapplicationsemesterproject.ViewHolder.CartItemAdapter;
...
public class ConfirmOrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getPickUpDate=getIntent().getStringExtra("pickup");
        ...
        df= FirebaseDatabase.getInstance().getReference().child("Cart List").child("User View").child(user.getUid()).child("Products");
        ...
        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
            ...
            if (dataSnapshot.exists())
            {
                for (DataSnapshot postSnapshot:dataSnapshot.getChildren())
                {
                    ...
                    Integer gettotalprice =  Integer.parseInt(cp.getRent());
                    String getProductCode=String.valueOf(cp.getPcode());
                    String getproductName=cp.getPname();
    ...
    public void confirmshipment(View view) {
        ...
        i.putExtra("pickUpDate",pickUpDate.getText().toString().trim());
        startActivity(i);
