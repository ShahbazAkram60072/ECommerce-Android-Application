...
public class CartItemAdapter extends RecyclerView.Adapter<CartItemAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, final int position) {
        ...
        myViewHolder.productName_cartList.setText(cp.getPname());
        myViewHolder.productPrice_cartList.setText("Rent="+cp.getRent()+" Pkr");
        Glide.with(mcontext).load(cp.imageUrl).into(myViewHolder.imageView);
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        switch (item.getItemId())
                        {
                            ...
                            case R.id.deleteCartItem:
                                ...
                                df= FirebaseDatabase.getInstance().getReference().child("Cart List").child("User View").child(user.getUid()).child("Products").child(cp.getPid());
                                df.removeValue();
