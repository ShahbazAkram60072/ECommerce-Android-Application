...
import com.shahbaz.rentadressapplicationsemesterproject.JavaClass.Favorite_Product;
...
public class FavoriteItemAdapter extends RecyclerView.Adapter<FavoriteItemAdapter.MyViewHolder> {
    ...
    @NonNull
    @Override
    public FavoriteItemAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final FavoriteItemAdapter.MyViewHolder myViewHolder, final int position) {
        final Favorite_Product fp=favorite_productList.get(position);

        myViewHolder.favItemName.setText(fp.getPname());
        myViewHolder.favRent.setText(fp.getRent());
        myViewHolder.favItemDescriptiop.setText(fp.getDescription());

        Glide.with(mcontext).load(fp.imageUrl).into(myViewHolder.imageView);
        ...
        myViewHolder.btnFavcancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                df= FirebaseDatabase.getInstance().getReference().child("favorite_List").child("User View").child(user.getUid()).child("Products").child(fp.getPid());
                df.removeValue();
