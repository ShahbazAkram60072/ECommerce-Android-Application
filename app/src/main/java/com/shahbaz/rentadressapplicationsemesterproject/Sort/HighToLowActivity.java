package com.shahbaz.rentadressapplicationsemesterproject.Sort;
...
public class HighToLowActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_high_to_low);
        setTitle("");
        ...
        rv=findViewById(R.id.rv_HightToLow);
