...
public class UserOrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtpickUp=findViewById(R.id.txtorderpickUp);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists())
                {
                    if (dataSnapshot.child("totalamount").exists())
                    {
                        ...
                        String rent=dataSnapshot.child("totalamount").getValue().toString();
                        String dilivery=dataSnapshot.child("deliveryDate").getValue().toString();
                        String returnDate=dataSnapshot.child("pickUpDate").getValue().toString();


                        txtUserName.setText(name);
                        txtphone.setText(phone);
                        txtOrderRent.setText("Rs "+rent);
                        txtdilivery.setText(dilivery);
                        txtpickUp.setText(returnDate);
